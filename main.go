...
func main() {
	...
	fmt.Println("  PUT    /api/repair-quote          - Update repair quote (shop callback)")
	...
	fmt.Println("  POST   /api/appeal                - Create appeal (freeze deposit)")
	...
	fmt.Println("  POST   /api/supplemental-evidence - Add supplemental evidence (op)")
	fmt.Println("  GET    /api/supplemental-evidence - List supplemental evidence")
	fmt.Println("  GET    /api/additional-compensation - List additional compensations")
	fmt.Println("  POST   /api/additional-compensation/collect - Mark compensation collected")
